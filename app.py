...
if clave == "27/04/2019":
    ...
    if st.button(" [ PULSE PARA INICIAR EL ESPECTÁCULO ] "):
        ...
        historia = [
            "Siete años de enamorados 💞 y casi tres compartiendo un hogar dejan una marca 💖 que ningún borrado de sistema puede quitar 🛠️. Hemos pasado por absolutamente de todo, desde momentos llenos de adrenalina como el canotaje en Tarapoto 🚣 donde la pasamos de la ctmr, hasta la inmensa alegría de poder cumplirte cada capricho, obsequiándote todo lo que querias o lo  que veías. Poder darte todo eso sabiendo que antes no teníamos cómo, ha sido de las satisfacciones más hermosas y puras ✨ que me llevo en el corazón ❤️.\n\n",
    ...
    st.error("❌ Esa no es la fecha, inténtalo de nuevo...")
